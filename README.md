...
sentinel *visible* (DOM: buffer scan; ghostty: OSC title change +
presented frame). DOM backends get VS Code-style flow control at **VS
Code's real constants** (100 K/5 K/5 K):
